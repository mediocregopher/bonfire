...
func (as addrString) String() string {
	return string(as)
}

func (as addrString) Network() string {
...
func TestZSet(t *T) {
	...
	t.Run("add", func(t *T) {
		...
		z.add(addrString("foo"))
		aa = append(aa, assertAddrs(z.timeL, "foo"))
		aa = append(aa, assertAddrs(z.usageL, "foo"))
		aa = append(aa, massert.Len(z.m, 1))

		z.add(addrString("bar"))
		aa = append(aa, assertAddrs(z.timeL, "foo", "bar"))
		aa = append(aa, assertAddrs(z.usageL, "foo", "bar"))
		aa = append(aa, massert.Len(z.m, 2))

		z.add(addrString("foo"))
		aa = append(aa, assertAddrs(z.timeL, "bar", "foo"))
		aa = append(aa, assertAddrs(z.usageL, "foo", "bar"))
		aa = append(aa, massert.Len(z.m, 2))

		z.add(addrString("baz"))
		aa = append(aa, assertAddrs(z.timeL, "bar", "foo", "baz"))
		aa = append(aa, assertAddrs(z.usageL, "foo", "bar", "baz"))
